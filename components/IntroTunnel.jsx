...
const PHRASE = 'N K Sharma Enterprises · '; // tiled on all 4 walls
  ...
  return (
    <div className={"intro-tunnel intro-" + phase + (phase === "out" ? " intro-fade" : "")}>
      ...
      <div className="intro-center">
        <div className="intro-logo"><span>N K Sharma Enterprises</span><span>REALTY</span></div>
